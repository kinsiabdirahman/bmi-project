...
app.post("/calculateBMI", urlEncodedParser, function (request, response) {
  ...
  if (completeBMIObject.bmi > 0) {
    if (completeBMIObject.bmi >= 25 && completeBMIObject.bmi <= 29.9)
      explainBMI = "Overweight";
    else if (completeBMIObject.bmi > 18.5 && completeBMIObject.bmi <= 24.9)
      explainBMI = "Normal";
...
app.get("/reports", function (request, response) {
  ...
  if (average > 0) {
    if (average >= 25 && average <= 29.9) explainAverage = "Overweight"; //
    else if (average > 18.5 && average <= 24.9) explainAverage = "Normal";
